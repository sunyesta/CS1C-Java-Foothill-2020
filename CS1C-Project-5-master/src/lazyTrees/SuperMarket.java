...
public class SuperMarket 
{
	...
	/**
	 * Instantiates inventory to be a lazyTrees.LazySearchTree of Item objects.
	 */
	public SuperMarket()
	{
	...
	{
		// TODO: Tests the lazyTrees.LazySearchTree by adding and removing items from the inventory
		final String TESTFILE = "resources/inventory_log.txt";	// Directory path for plain-text file
		//final String TESTFILE = "resources/inventory_log_custom.txt";	// Directory path for plain-text file

		// NOTE: Short inventory file to test for removal of root node from lazyTrees.LazySearchTree
