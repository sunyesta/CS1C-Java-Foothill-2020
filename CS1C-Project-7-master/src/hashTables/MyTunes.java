...
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		//final String TESTFILE01 = "resources/findIDsRepeated.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/findGenresRepeated.txt"; // Example test file for hashing based on genres names

		//final String TESTFILE01 = "resources/empty.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/empty.txt"; // Example test file for hashing based on genres names

		//final String TESTFILE01 = "resources/blank.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/blank.txt"; // Example test file for hashing based on genres names
