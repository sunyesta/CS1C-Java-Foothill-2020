 ...
 * @param <E> the data type of the objects being passed in
...
public class FHhashQP<E>
{
    ...
    /**
     * instantiates the mArray with the specified size and fills it with empty hashEntries
    ...
    /**
     * instantiates the mArray with the default size and fills it with empty hashEntries
     */
    public FHhashQP()
    {
     ...
     * @param x the element that is being inserted
     * @return false if the state of the corresponding is active, true if it isn't
     */
     ...
     * @return false if hash entry of the element isn't active, else true
     */
    ...
    /**
     * checks if an object is contained in the hash table
     * @param x the object
     * @return true if th object is contained, else false
     */
    ...
    /**
     * sets the MaxLambda
     * @param lam the specified MaxLambda
     * @return false if lam < .1 or bigger than INIT_MAX_LAMBDA, else false
     */
    ...
    /**
     * the function for determining the location of the object you want to insert
     * @param x the object you want to insert
     * @return the index of the object
     */
    ...
    /**
     * fills the mArray with empty hash entries
     */
    void allocateArray()
    {
        int k;
